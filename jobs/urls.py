...
from jobs.views import ApplicationCreateView, EmployerApplicationListView, ApplicantApplicationListView, \
    ...
    FavoriteVacanciesListView, VacancyDeleteView, VacancyCreateView, VacancyDetailView, VacancyListView, SearchView
...
urlpatterns = [
    ...
    path('create_vacancy/', VacancyCreateView.as_view(), name='create_vacancy'),
